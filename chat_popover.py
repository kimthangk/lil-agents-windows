...
from PyQt6.QtWidgets import (
    QDialog, QVBoxLayout, QHBoxLayout, QFrame, QTextEdit, QLineEdit,
...
class ChatPopover(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        # Header — QFrame paints its background correctly with WA_TranslucentBackground
        header_wrap = QFrame()
        header_wrap.setStyleSheet(
            f"QFrame {{ background: transparent; border-left: 3px solid {self._accent}; padding-left: 4px; }}"
        )
